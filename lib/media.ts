...
export const imageCrops = {
  /**
   * 심바키즈 서비스 화면 (4분할 화상 수업).
   * 교체된 원본은 여백 없이 캔버스를 꽉 채운다(잉크 100% x 100%).
   * 잘라낼 것이 없으므로 캔버스 전체를 쓰고 여백도 0 으로 둔다.
   * pad 를 남겨두면 캔버스 밖을 잡아 가장자리에 빈 띠가 생긴다.
   */
  solution1: {
    crop: { canvasW: 324, canvasH: 216, x: 0, y: 0, w: 324, h: 216 },
    pad: 0,
  },
  /** AI 부모코칭 서비스 화면 */
  solution2: {

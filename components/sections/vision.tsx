...
const values = [
  {
    title: "기준을 높게",
    body: "익숙한 수준에 만족하지 않습니다. 끊임없이 기준을 높이고, 한계를 넘어 더 나은 결과를 만듭니다.",
  },
  {
    title: "주도적으로",
    body: "더 나은 결과를 위해 스스로 판단하고 실행합니다. 서로를 존중하며 적극적으로 소통하고, 팀의 목표를 위해 필요한 일을 함께 만들어갑니다.",
  },
  {
    title: "빠르게",
    body: "실패를 두려워하기보다 빠르게 시도하고 배웁니다. 어제보다 오늘 더 나은 사람이 되고, 그 성장의 속도를 즐깁니다.",
  },
  {
    title: "끝까지",
    body: "쉽게 포기하지 않습니다. 안 되는 이유보다 될 수 있는 방법을 찾으며, 끝까지 최선의 답을 만들어갑니다.",
  },
];
      ...
      <ul className="mt-14 grid grid-cols-2 gap-3 sm:mt-16 lg:grid-cols-4 lg:gap-4">
        {photos.map((photo) => (
          ...
          >
            ...
            <span
              className={cn(
                "t-title absolute inset-x-0 bottom-3 text-center sm:bottom-4 text-5xl",
